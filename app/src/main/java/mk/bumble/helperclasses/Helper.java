package mk.bumble.helperclasses;
...
public class Helper {
    ...
    public static void changeTransitionDrawableColor(View view, int color) {
        PorterDuff.Mode selected = SRC;
        TransitionDrawable transitionDrawable = (TransitionDrawable) view.getBackground();
        transitionDrawable.setColorFilter(color, selected);

    }

    public static void changeTransitionDrawableBackground(View view, Drawable drawable) {
        PorterDuff.Mode selected = SRC;
        TransitionDrawable transitionDrawable = (TransitionDrawable) view.getBackground();
...
//            if (drawable != null) {
//                drawable.setColorFilter(new PorterDuffColorFilter(ContextCompat.getColor(textView.getContext(), color), PorterDuff.Mode.SRC_OVER));
//            }
//        }
        PorterDuff.Mode selected = SRC;
        GradientDrawable gd = (GradientDrawable) textView.getBackground();
        gd.setColorFilter(color, selected);
    }
